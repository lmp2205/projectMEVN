            ...
            <v-col sm="10" class="mx-auto">
                <v-card class="pa-5">
                    ...
                    <v-form ref="form" class="pa-5" @submit.prevent="updateForm" enctype="multipart/form-data">
                        ...
                        <v-text-field label="Image" v-model="post.image" prepend-icon="mdi-view-list"
                            :rules="rules"></v-text-field>
                            <v-img  height="120" :src="`${post.image}`"></v-img>
                        <!-- <v-file-input  v-model="post.image" :rules="rules" show-size counter multiple
